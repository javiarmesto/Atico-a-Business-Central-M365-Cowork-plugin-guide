...
The plugin connects Cowork to the **standard Business Central MCP** through a TypeScript bridge with delegated OAuth, dynamic discovery and List queries over API pages. The bridge supports reads only.

[Native connection](native/README.md) · [Deployment guide](native/HOW-TO-BC-NATIVE-COWORK.en.md)
...
The template uses your own deployment configuration and OAuth identity.
